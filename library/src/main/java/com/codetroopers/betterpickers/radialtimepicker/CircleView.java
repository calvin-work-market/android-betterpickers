...
public class CircleView extends View {
    ...
    /* package */ void setTheme(TypedArray themeColors) {
        mCircleColor = themeColors.getColor(R.styleable.BetterPickersDialog_bpMainColor1, getResources().getColor(R.color.bpWhite));
        mDotColor = themeColors.getColor(R.styleable.BetterPickersDialog_bpMainColor2, getResources().getColor(R.color.numbers_text_color));
    }
